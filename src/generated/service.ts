...
export const RunnerConfig: MessageFns<RunnerConfig> = {
  encode(message: RunnerConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.uri !== "") {
      writer.uint32(10).string(message.uri);
    }
    if (message.config !== "") {
  ...
  create<I extends Exact<DeepPartial<RunnerConfig>, I>>(base?: I): RunnerConfig {
    return RunnerConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RunnerConfig>, I>>(object: I): RunnerConfig {
    const message = createBaseRunnerConfig();
    message.uri = object.uri ?? "";
    message.config = object.config ?? "";
    message.arguments = object.arguments?.map((e) => Processor.fromPartial(e)) || [];
    return message;
  },
};
...
export const RunnerService = {
  init: {
    ...
    requestSerialize: (value: Processor) => Buffer.from(Processor.encode(value).finish()),
...
export interface RunnerClient extends Client {
  init(request: Processor, callback: (error: ServiceError | null, response: Empty) => void): ClientUnaryCall;
  init(
    request: Processor,
    metadata: Metadata,
  ...
  start(metadata: Metadata, options?: Partial<CallOptions>): ClientDuplexStream<Message, Message>;
}

export const RunnerClient = makeGenericClientConstructor(RunnerService, "mypackage.Runner") as unknown as {
...
export interface MyServiceClient extends Client {
  sayHello(request: Request, callback: (error: ServiceError | null, response: Response) => void): ClientUnaryCall;
  sayHello(
    request: Request,
    metadata: Metadata,
