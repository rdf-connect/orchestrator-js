...
for (const processorType of types) {
    describe(`Orchestrator Pipeline Management with processors using ${processorType} properties`, () => {
        let fixture: OrchestratorTestFixture

        beforeEach(async () => {
            fixture = new OrchestratorTestFixture()
            await fixture.setupPipeline(processorType)
        })
        ...
        describe('Pipeline Configuration', () => {
            ...
            test('should parse pipeline with correct number of runners and processors', () => {
                ...
                const totalProcessors =
                    fixture.orchestrator.pipeline.parts.reduce(
            ...
            test('should start processors with correct arguments', () => {
                const stateMock = {
                ...
                fixture.orchestrator.pipeline.parts.forEach((part) => {
                    part.processors.forEach((processor) => {
                        ...
                        console.log(processorType, args)
                    })
                })
            })
        })
        ...
        describe('Runner Communication', () => {
            ...
            test('should route messages between processors correctly', async () => {
                ...
                expect(runner1.messages.length).toBe(
                    initialRunner1MessageCount + 1,
                )
